...
<head>
    ...
    <title>Redefinição de Senha - SisBrasFute</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 32px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <!-- Instruction text -->
                                <tr>
                                    <td style="font-size: 16px; color: #374151; line-height: 1.6; padding-bottom: 16px;">
                                        Recebemos uma solicitação para redefinir a senha da sua conta no SisBrasFute.
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td align="center" style="background-color: #f97316; border-radius: 6px;">
                                                    <a href="{{ $resetUrl }}" target="_blank" style="display: inline-block; padding: 14px 32px; font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; letter-spacing: 0.5px;">REDEFINIR MINHA SENHA</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
