...
<head>
    ...
    <title>Vaga Disponível - SisBrasFute</title>
</head>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td style="font-size: 16px; color: #374151; line-height: 1.6; padding-bottom: 24px;">
                                        Uma vaga ficou disponível em uma partida do seu time! Confira os detalhes:
                                    </td>
                                </tr>
                                <!-- Match details box -->
                                <tr>
                                ...
                                <tr>
                                    <td style="font-size: 16px; color: #374151; line-height: 1.6; padding-bottom: 32px;">
                                        Garanta sua vaga agora! Escolha sua posição e confirme sua participação:
                                    </td>
                                </tr>
                                <!-- Button -->
                                <tr>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td align="center" style="background-color: #f97316; border-radius: 6px;">
                                                    <a href="{{ $participateUrl }}" target="_blank" style="display: inline-block; padding: 14px 32px; font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; letter-spacing: 0.5px;">VER VAGA</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
